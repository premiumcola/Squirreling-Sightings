...
import { liftDossierOutOfGrid, placeDossierUnderRow } from './_dossier-placement.js';
...
export function renderAchievements() {
  ...
  if (grid) {
    // The dossier panel may be sitting inside this grid from the last
    // open — out first, or the rewrite below deletes it.
